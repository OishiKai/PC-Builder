    ...
    return _then(_value.copyWith(
      ...
      detailUrl: null == detailUrl
          ...
          : detailUrl // ignore: cast_nullable_to_non_nullable
              as String,
      fullScaleImages: freezed == fullScaleImages
          ? _value.fullScaleImages
          : fullScaleImages // ignore: cast_nullable_to_non_nullable
              as List<String>?,
      specs: freezed == specs
          ? _value.specs
...
class _$_PcParts implements _PcParts {
  ...
  final List<String>? _fullScaleImages;
  @override
  List<String>? get fullScaleImages {
    final value = _fullScaleImages;
    if (value == null) return null;
    if (_fullScaleImages is EqualUnmodifiableListView) return _fullScaleImages;
