...
class _$_PcParts extends _PcParts {
  const _$_PcParts(
      {required this.id,
  ...
  @override
  String toString() {
    return 'PcParts(id: $id, category: $category, maker: $maker, isNew: $isNew, title: $title, star: $star, evaluation: $evaluation, price: $price, ranked: $ranked, image: $image, fullScaleImageCount: $fullScaleImageCount, specs: $specs, shops: $shops)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.fullScaleImageCount, fullScaleImageCount) ||
                other.fullScaleImageCount == fullScaleImageCount) &&
